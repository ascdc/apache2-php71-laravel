...
RUN DEBIAN_FRONTEND=noninteractive && apt-get update && \
	apt-get -y upgrade && \
	apt-get install -y ^apache2$ ^php7\.1$ ^php7\.1-common$ ^php7\.1-json$ ^php7\.1-opcache$ ^php7\.1-zip$ ^php7\.1-mysql$ ^php7\.1-phpdbg$ ^php7\.1-gd$ ^php7\.1-imap$ ^php7\.1-ldap$ ^php7\.1-pgsql$ ^php7\.1-pspell$ ^php7\.1-recode$ ^php7\.1-tidy$ ^php7\.1-intl$ ^php7\.1-curl$ ^php7\.1-mcrypt$ ^php7\.1-xmlrpc$ ^php7\.1-xsl$ ^php7\.1-bz2$ ^php7\.1-mbstring$ pkg-config libmagickwand-dev imagemagick build-essential libsasl2-dev libpcre3-dev && \
