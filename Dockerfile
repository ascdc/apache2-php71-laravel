...
RUN DEBIAN_FRONTEND=noninteractive && apt-get update && \
	...
	/bin/ln -sf /etc/php/7.1/mods-available/imagick.ini /etc/php/7.1/apache2/conf.d/20-imagick.ini
	/bin/ln -sf /etc/php/7.1/mods-available/imagick.ini /etc/php/7.1/cli/conf.d/20-imagick.ini
	/bin/ln -s ../mods-available/rewrite.load /etc/apache2/mods-enabled/rewrite.load && \
